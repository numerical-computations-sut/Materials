...
معادله‌ی خطی
$Ax = b$
را با مقادیر زیر در نظر بگیرید:
\begin{LTR}
\begin{center}
A = $\begin{pmatrix}
4 & 1 & -2\\
...
\begin{enumerate}
    ...
    \end{align*}
    \item 
    جواب واقعی (به دست آمده از ولفرام)
    \begin{align*}
        \begin{cases}
            x_1 = 1.2753623188 \\ 
            x_2 = 0.5217391304 \\
    ...
    \begin{align*}
        ...
        \end{cases}
    \end{align*}
    به وضوح جواب‌های به دست آمده از (ب) نزدیک‌تر هستند، پس گاوس سایدل تقریب بهتری از جواب‌ها می‌دهد.
\end{enumerate}
}