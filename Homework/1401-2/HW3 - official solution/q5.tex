بهترین منحنی به شکل 
$y = ax^2$
که داده‌های زیر را برازش کند به دست آورید.
	\begin{center}
...
حل
\\
فرض می‌کنیم منظور هر تابع درجه ۲ دل‌خواه نیست و صرفاً به شکل 
$\underline{ax^2}$
مدنظر است.
در این حالت، به ازای یک 
$a$
فرضی (متغیر) فاصله‌ی تابع درون‌یابی را با مقدارهای واقعی به دست می‌آوریم و در اینجا مثلاً سعی می‌کنیم
