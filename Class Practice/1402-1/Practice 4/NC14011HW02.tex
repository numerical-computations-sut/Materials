...
\long\def\makeHead#1{%
	\begin{center}\large
		\begin{tabular}{@{}p{.33\linewidth}<{\hfill}@{}>{\hfil}p{.33\textwidth}<{}@{}>{\hfill}p{.33\textwidth}@{}}
            \textbf{محاسبات عددی} & & \textbf{فعالیت کلاسی - مشتق} \\[.5ex]
...
% 	\Rule
	\item{\textbf{سوال 1.}} \input{NC14011HW02-q1}
	\\
	\item{\textbf{جواب سوال 1.}} \input{NC14011HW02-s1}
